...
plot = @pgf Axis(
    {
        ...
        ylabel="GFlops",
        title="Matrix Multiplication Performance GFlops",
    },
    Plot({no_marks, "blue"}, Table(N, GFLOPS_GPU)),
)

PGFPlotsX.save("/ALVARO/Documentacion GPU/doc_latex/code/3/grafico_GFLOPS_GPU.tex", plot, include_preamble=false)
