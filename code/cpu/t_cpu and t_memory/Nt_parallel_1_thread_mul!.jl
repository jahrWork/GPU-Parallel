...
function matrix_mult!_parallel(A, B, Nt)
    @threads for i in 1:Nt
        mul!(C, A, B)
    end
end
...
dt1 = @belapsed C = A * B # 
dt2 = @belapsed mul!(C, A, B)
dt3 = ( @belapsed matrix_mult_parallel(A, B, Nt) ) / Nt
dt4 = ( @belapsed matrix_mult!_parallel(A, B, Nt) ) / Nt

println("Time 1: ", dt1 * 10^6, " μs - GFLOPS: ", 2 * N^3 / (dt1 * 10^9))
println("Time 2: ", dt2 * 10^6, " μs - GFLOPS: ", 2 * N^3 / (dt2 * 10^9))
println("Time 3: ", dt3 * 10^6, " μs - GFLOPS: ", 2 * N^3 / (dt3 * 10^9))
println("Time 4: ", dt4 * 10^6, " μs - GFLOPS: ", 2 * N^3 / (dt4 * 10^9))
